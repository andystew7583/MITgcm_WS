...
% Create textbox
annotation(gcf,'textbox',...
  [0.356 0.39152483801296 0.0299999999999999 0.0300000000000001],...
  'String','RLIS',...
  'LineStyle','none',...
  'Interpreter','latex',...
  'FontSize',14,...
...
% Create textbox
annotation(gcf,'textbox',...
  [0.858000000000001 0.39152483801296 0.0299999999999999 0.0300000000000001],...
  'String','RLIS',...
  'LineStyle','none',...
  'Interpreter','latex',...
  'FontSize',14,...
...
% Create textbox
annotation(gcf,'textbox',...
  [0.209 0.265524838012959 0.0299999999999999 0.03],'String','SWIT',...
  'LineStyle','none',...
  'Interpreter','latex',...
  'FontSize',14,...
  'FitBoxToText','off');
...
% Create textbox
annotation(gcf,'textbox',...
  [0.707000000000001 0.263524838012959 0.0299999999999999 0.03],...
  'String','SWIT',...
  'LineStyle','none',...
  'Interpreter','latex',...
  'FontSize',14,...

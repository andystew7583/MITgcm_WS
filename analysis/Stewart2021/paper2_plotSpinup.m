...
plot(tt_onethird_tides/t1year-1/24,-SHImelt_onethird_tides/1e12*t1year,'-','Color',colororder(1,:),'LineWidth',linewidth);
hold on;
plot((tt_onesixth_tides+9*t1year)/t1year-1/24,-SHImelt_onesixth_tides/1e12*t1year,'-','Color',colororder(2,:),'LineWidth',linewidth);
plot((tt_onetwelfth_tides+18*t1year)/t1year-1/24,-SHImelt_onetwelfth_tides/1e12*t1year,'-','Color',colororder(3,:),'LineWidth',linewidth);
plot(tt_onethird_notides/t1year-1/24,-SHImelt_onethird_notides/1e12*t1year,'--','Color',colororder(1,:),'LineWidth',linewidth);
plot((tt_onesixth_notides+9*t1year)/t1year-1/24,-SHImelt_onesixth_notides/1e12*t1year,'--','Color',colororder(2,:),'LineWidth',linewidth);
plot((tt_onetwelfth_notides+18*t1year)/t1year-1/24,-SHImelt_onetwelfth_notides/1e12*t1year,'--','Color',colororder(3,:),'LineWidth',linewidth);
hold off;
set(gca,'XLim',[18 27]);
set(gca,'Ylim',[90 250]);

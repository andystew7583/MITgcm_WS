...
axpos(2,:) = [0.01 0.0 .5 .45];
axpos(3,:) = [0.47 0.0 .55 .45];
cbpos = zeros(2,4);
cbpos(1,:) = [0.7 0.56 0.01 .1];
cbpos(2,:) = [0.46 0.06 0.01 .1];
...
annotation(figure1,'textbox',...
  [0.62 0.47538228941685 0.392 0.0242980561555076],...
...
% Create textbox
annotation(figure1,'textbox',...
  [0.15 0.47538228941685 0.33 0.0242980561555073],...
...
% Create textbox
annotation(figure1,'textbox',...
  [0.36 0.959583153347735 0.3085 0.0242980561555075],...

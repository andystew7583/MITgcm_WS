%%%
%%% paper3_plotFreshwaterFunction.m
%%%
...
axpos(2,:) = [0.07 0.06 .86 .38];
cbpos1 = [0.95 0.56 0.01 .38];
cbpos2 = [0.95 0.06 0.01 .38];
...
clabel(C,h,'FontSize',fontsize-4,'LabelSpacing',200);
hold off;
...
% Create arrow
annotation(figure1,'arrow',[0.817 0.774000000000001],...
  [0.922246220302376 0.931965442764582],...
  'Color',[0.894117647058824 0.450980392156863 0.894117647058824],...
  'LineWidth',2,...
  'HeadStyle','plain');

% Create arrow
annotation(figure1,'arrow',[0.914 0.857],...
  [0.909287257019439 0.922246220302382],...
  'Color',[0.894117647058824 0.450980392156863 0.894117647058824],...
  'LineWidth',2,...
  'HeadStyle','plain');

% Create arrow
annotation(figure1,'arrow',[0.778 0.717000000000001],...
  [0.904967602591793 0.930885529157672],...
  'Color',[0.894117647058824 0.450980392156863 0.894117647058824],...
  'LineWidth',2,...
  'HeadStyle','plain');

% Create arrow
annotation(figure1,'arrow',[0.874 0.817],...
  [0.890928725701946 0.903887688984888],...
  'Color',[0.894117647058824 0.450980392156863 0.894117647058824],...
  'LineWidth',2,...
  'HeadStyle','plain');

% Create arrow
annotation(figure1,'arrow',[0.9 0.837],...
  [0.429805615550756 0.427645788336939],...
  'Color',[0.894117647058824 0.450980392156863 0.894117647058824],...
  'LineWidth',2,...
  'HeadStyle','plain');
...
annotation(figure1,'arrow',[0.759 0.698000000000001],...
  [0.425485961123111 0.425485961123113],...
  'Color',[0.894117647058824 0.450980392156863 0.894117647058824],...
  'LineWidth',2,...
  'HeadStyle','plain');

...
set(hh,'fontsize',12,'Color',[.05 .05 .05],'BackgroundColor','none','Edgecolor','none')       
% Nlon = 101;
...
annotation(figure1,'textbox',...
  [0.579 0.98197264218865 0.4085 0.0242980561555076],...
...
% Create arrow
annotation(figure1,'arrow',[0.369 0.295],...
  [0.814603131749461 0.814603131749462],'Color',[0 0.447 0.741],...
  'LineWidth',30,...
  'HeadWidth',60,...
  'HeadStyle','plain',...
  'HeadLength',35);
...
% Create textbox
annotation(figure1,'textbox',...
  [0.385 0.824447264218866 0.0499999999999997 0.0242980561555076],...
...
annotation(figure1,'arrow',[0.471 0.408000000000002],...
  [0.875 0.875188984881213],'Color',[0.494 0.184 0.556],'LineWidth',30,...
  'HeadWidth',60,...
  'HeadStyle','plain',...
  'HeadLength',35);

% Create arrow
annotation(figure1,'arrow',[0.403 0.403],[0.9 0.97042566594673],...
  'Color',[0.85 0.325 0.098],...
  'LineWidth',30,...
  'HeadWidth',60,...
  'HeadStyle','plain',...
...
% Create textbox
annotation(figure1,'textbox',...
  [0.284 0.751113930885537 0.0499999999999998 0.0242980561555076],...
  'Color',[0 0.447 0.741],...
...
annotation('textbox',[axpos(1,1)-0.06 axpos(1,2)-0.05 0.03 0.03],'String',axlabels{1},'interpreter','latex','FontSize',fontsize+2,'LineStyle','None');

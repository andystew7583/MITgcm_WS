...
expnames = {...
  ...
  'WC_onethird_dpyc-150_strat4e-4',...
  'WC_onethird_dpyc-150_strat4e-4_C450'};
...
titles = {...
  ...
  'Freshwater + curtain', ...
  'Freshwater + shallow pycnocline', ...
  'Freshwater + shallow pycnocline + curtain'};

%%% To store output structures
diags_curtain = cell(1,length(expnames));

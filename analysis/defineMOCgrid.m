...
%     etafrac = 1;
  ...
  elseif (gl_coord)
    ...
    %%% Transition value of eta: coordinates look like ETA0 to the ''south''
    %%% of this value
    eta_t2 = -2;    
    ...
    ETA2(ETA0<=eta_t2) = ETA0(ETA0<= eta_t2);
    ...
    ETA1(ETA2==eta_if) = NaN;    
    % ETA1((ETA2 > eta_if) & (ETA0 < eta_t)) = NaN;    
    ETA1(ETA0>=eta_t) = ETA0(ETA0>=eta_t);
    ETA1((YC>-78.2286) & (XC>-36.0625)& (icedraft<0) & (icedraft>bathy)) = NaN;
    ETA1((YC>-74.6) & (XC<-59.5) & (icedraft<0) & (icedraft>bathy)) = NaN;

...
text(-6.5,27.4,'Overturning streamfunction s.d.','FontSize',fontsize+2);
...
plot(times/t1year,psimax_full/1e6);
hold on;
plot(times/t1year,0*times,'k--');
hold off;
xlabel('Time (years)');
...
hold on;
plot(times/t1year,pc(1,:)/std(pc(1,:)),'Color',colororder(2,:));
plot(times/t1year,-(bflux_int)/std(bflux_int),'Color',colororder(3,:));
...
plot(times/t1year,smooth(psimax_full,12)/1e6)
xlabel('Time (years)');
% ylabel('Overturning (Sv)')
set(gca,'FontSize',fontsize);
set(gca,'YColor',colororder(1,:));
...
plot([0 0],[0 0],'Color',colororder(1,:));
hold on;
plot(times/t1year,smooth(pc_noseason(1,:)/std(pc_noseason(1,:)),12),'Color',colororder(2,:));
...
plot(times/t1year,-smooth((bflux_int_shelf_noseason)/std(bflux_int_shelf_noseason),12,'moving'),'Color',colororder(3,:));
...
% pvar = -smooth((bflux_int_shelf_noseason)/std(bflux_int_shelf_noseason),12,'rlowess');
...
xlabel('MOC coordinate, \eta');
ylabel('Potential density (kg/m^3)')
text(-6.8,27.4,['First EOF (',num2str(expvar_cavity(1),'%.1f'),'% of variance)'],'FontSize',fontsize+2);
set(gca,'FontSize',fontsize);
set(gca,'Color',[.85 .85 .85]);
...
xlabel('MOC coordinate, \eta');
% ylabel('Potential density (kg/m^3)')
text(-2.8,27.4,['First EOF (',num2str(expvar_shelf(1),'%.1f'),'% of variance)'],'FontSize',fontsize+2);
set(gca,'FontSize',fontsize);
set(gca,'Color',[.85 .85 .85]);
...
%%% Time series of streamfunction strength
subplot('Position',axpos(3,:));
plot(times/t1year,psimax_cavity/1e6);
hold on;
plot(times/t1year,0*times,'k--');
hold off;
xlabel('Time (years)');
...
plot([0 0],[0 0],'Color',colororder(1,:));
hold on;
plot(times/t1year,-pc_cavity(1,:)/std(pc_cavity(1,:)),'Color',colororder(2,:));
plot(times/t1year,-(bflux_int_shelf)/std(bflux_int_shelf),'Color',colororder(3,:));
hold off;
set(ax2,'Color','None');
set(ax2,'XAxisLocation','Bottom');
set(ax2,'YAxisLocation','Right');
...
%%% Time series of streamfunction strength, interannual
subplot('Position',axpos(4,:));
plot(times/t1year,smooth(psimax_shelf,12)/1e6)
xlabel('Time (years)');
% ylabel('Overturning (Sv)')
set(gca,'FontSize',fontsize);
set(gca,'YColor',colororder(1,:));
...
plot([0 0],[0 0],'Color',colororder(1,:));
hold on;
plot(times/t1year,smooth(pc_shelf(1,:)/std(pc_shelf(1,:)),12),'Color',colororder(2,:));
% plot(times/t1year,-smooth((bflux_int_shelf-mean(bflux_int_shelf))/std(bflux_int_shelf),12),'Color',colororder(3,:));
% plot(times/t1year,-smooth((bflux_int_shelf_noseason-mean(bflux_int_shelf_noseason))/std(bflux_int_shelf_noseason),12),'Color',colororder(3,:));

...
set(h,'Position',[0.262000000000001,0.773218142548605,0.011000000000001,0.156198704103672]);
...
h = colorbar;
set(gca,'FontSize',fontsize);
set(h,'Position',[0.85 0.45 0.01 .15])
tightmap;
...
fontsize = 18;
labelspacing = 200;
axpos(3,:) = [0.08 0.07 0.83 0.3];
cb_pos = [0.94 0.07 0.015 0.3];
axlabel = '(c)';
icecolor = [186 242 239]/255;

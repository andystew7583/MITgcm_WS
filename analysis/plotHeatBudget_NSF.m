...
%%% Add coordinat contours
ETA_plot = ETA;
ETA_plot(sum(hFacC,3)==0) = NaN;
hold on;
[cs,C] = contourm(YC,XC,ETA_plot,[-9:1:10],'EdgeColor',[.5 .5 .5]); 
hh = clabelm(cs,C);
[cs,C] = contourm(YC,XC,ETA_plot,[-9:0.5:10],'EdgeColor',[.5 .5 .5]); 
set(hh,'fontsize',8,'Color',[.5 .5 .5],'BackgroundColor','none','Edgecolor','none')       
% Nlon = 101;

...
%%%%%%%% FOR 1/24th degree --- loading S, T, P for iceloadanom
...
% 
    ...
    fid = fopen(fullfile(inputfolder,pSurfInitFile),'r','b');
    Modelsurfaceheight = fread(fid,[Nx Ny],'real*8'); 
    fclose(fid);
